...
# hupi-import, hupi-rotate-key, hupi-reembed, hupi-demo, hupi-demo-sweep)
# from the exact same image via `command:` overrides — one build, one
# thing to version and scan for vulnerabilities, not twelve.
